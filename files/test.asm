...
;
		...
		ORG	00100H
;
; Initialize 8251 console UART
;
INIT:	MVI	A,3	; Non MODE set
	OUT	6	; Insure in COMMAND mode
	OUT	6	; So we can reliably switch to MODE register
	MVI	A,77h	; Select MODE, RTS, ResetError RXE, DTR, TXE
	OUT	6	; Write 8251 command register
	MVI	A,7Ah	; 1-Stop, Even Parity, 7-Data, x1 speed (9600)
	OUT	6	; Write 8251 MODE register
	MVI	A,37h	; RTS, ResetError, RXE, DTR, TXE
	OUT	6	; Write 8251 command register
	JMP	CPU	;JUMP TO 8080 CPU DIAGNOSTIC
;
	STR	'MICROCOSM ASSOCIATES 8080/8085 CPU DIAGNOSTIC'
...
OKCPU:	DB	0CH,0DH,0AH
	STR	' CPU IS OPERATIONAL$'
;
NGCPU:	DB	0CH,0DH,0AH
	STR	' CPU HAS FAILED!    ERROR EXIT=$'
;
;
;
;************************************************************
