10 REM   THIS DEMONSTRATION IS CONVERTED FROM PDP-11 BASIC
...
330 PRINT "TIMEOUTS PER HALF.  TYPING '3' WILL REPRINT THE CODES." 
340 PRINT
350 PRINT
370 DIM R(17)
380 FOR I=0 TO 17
...
420 REM RANDOMIZE - NOT IMPLEMENTED IN 4K BASIC
430 LET F=0
440 LET Z3=0
450 LET O=0
460 LET L=0
470 REM DIM Z(5,3),P(2),D(2,5) 
471 DIM Z(24):DIM P(2):DIM D(18)
480 FOR A=0 TO 5 
490 FOR B=0 TO 2 
500 READ Z(A+B*6),D(B+A*3) 
505 LET P(B)=0
510 NEXT B 
520 READ Z(A+18)
530 NEXT A 
...
640 LET F1=50
641 R1=1:R2=1
642 FOR I=1 TO 7:R1=R1*RND(0):NEXT I
643 FOR I=1 TO 3-Z2:R2=R2*RND(0):NEXT I
650 LET B=INT(F1+O*20*RND(0)+(1-O)*29*(2-R1-R2))
660 LET O=0
670 LET Z9=8 
680 GOSUB 1490
690 LET L=0
...
970 GOTO 1000
980 LET Y=Q-8
990 IF (ABS(Q-10.5)*ABS(Q-10.5))>3 THEN 920
1000 LET C=INT(C-L*(5+23*RND(X))) 
1010 LET L=1
1020 IF M=7 THEN 1760
1030 IF M=8 THEN 1920
1040 LET Y1=Y-1 
1050 IF RND(X)>Z(M-1+Y1*6) THEN 1240
1060 LET A=2
1070 GOSUB 3020
...
1770 LET B=B+30+INT(15*(1-RND(X)*RND(X)*RND(X)))
1780 LET Z9=2 
1790 GOSUB 1490
...
2040 IF RND(X)<((B/132)*(B/132)*(B/132)*(B/132)) THEN 2070
2050 LET P1=0 
2060 PRINT "NO "; 
2070 PRINT "GOOD" 
2080 LET P(S)=P(S)+P1 
...
2410 LET G=INT(24*(1-RND(X)*RND(X))) 
...
2580 LET M=INT(6-4*RND(0)*RND(0))
...
3060 LET Q=-Q 
3070 LET M1=M-1 
3080 LET G=D(A+M1*3)+(SIN(Q)/SIN(Q+1.5708))*(D(2+M1*3)-D(A+M1*3))/3.5
...
3580 GOSUB 3520
3590 GOTO 3610
3600 GOSUB 4000:PRINT "... TRY AGAIN" 
3610 INPUT A
...
4000 REM   PRINT INSTRUCTIONS SUBROUTINE
4100 PRINT "ON OFFENSE YOU HAVE THE FOLLOWING PERMITTED PLAYS:" 
4110 PRINT "PLAY","CODE"
4120 PRINT "RUN","10" 
4130 PRINT "PASS","11"
4140 PRINT "SWEEP","12" 
4150 PRINT "SCREEN PASS","13" 
4160 PRINT "LONG PASS","14" 
4170 PRINT "DRAW PLAY","15" 
4180 PRINT "PUNT","16"
4190 PRINT "FIELDGOAL","17" 
4200 PRINT
4210 PRINT "ON DEFENSE, YOU MAY TRY ONE OF THE FOLLOWING:"
4220 PRINT "DEFENSE","CODE" 
4230 PRINT "NORMAL","4","GOOD AGAINST SWEEP AND SCREEN" 
4240 PRINT "HOLD","5","GOOD AGAINST RUN, PASS AND DRAW" 
4250 PRINT "BLITZ","6","GOOD AGAINST PASS OR LONG PASS" 
4260 PRINT "INTERCEPT","7","INCREASES THE ODDS FOR AN INTERCEPTION" 
4270 PRINT "BLOCK","8","GIVES YOU A CHANCE TO BLOCK A KICK,"
4280 PRINT " "," ","BUT DECREASES THE DISTANCE RUNBACK."
4290 PRINT
4300 RETURN
9999 END
